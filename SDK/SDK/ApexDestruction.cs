...
namespace SDK.Script.ApexDestructionSDK
{
    ...
    {
        public DestructibleActor(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleComponent(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleFractureSettings(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleMesh(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleChunkParameters(ulong addr) : base(addr) { }
    ...
    {
        public FractureMaterial(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleParameters(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleParametersFlag(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleDepthParameters(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleSpecialHierarchyDepths(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleAdvancedParameters(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleDebrisParameters(ulong addr) : base(addr) { }
    ...
    {
        public DestructibleDamageParameters(ulong addr) : base(addr) { }
